    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          ...
          <p class="pull-right"><i class="fa fa-ambulance"></i>Order Online +92-322-8186509</p>
        </div>
      </div>
    </div>
  </div>
            ...
            <nav class="navbar navbar-default">
              ...
              <div id="fixed-collapse-navbar" class="navbar-collapse collapse navbar-right">
                <ul class="nav navbar-nav">
                  ...
                  <li><a href="blog.html" style="color : #e25111;background-color: white;">blog</a></li>
      ...
      <div class="row">
        <div class="col-md-8 col-sm-7">
          ...
          <ul class=\"comments\">
            ...
            <li><a href=\"#\">Written By: " . $row["Writer"] . "</a></li>
          </ul>
        ...
        <div class="col-md-4 col-sm-5">
          ...
          <form class="callus" action="s_blog.php" method="POST" enctype="multipart/form-data">
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    <input class="form-control" id="name" name="name" type="text" required placeholder="Your Name" required>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <input class="form-control" id="date" name="date" type="date" required placeholder="Date" required>
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    <textarea placeholder="Blog" id="Blog" name="blog"></textarea>
                  </div>
                  <div class="form-group">
                    <input type="file" name="image" id="image">
                  </div>
                  <div class="form-group">
                    <button type="submit" class="btn-submit button3">Submit</button>
                  </div>
                </div>
              </div>
            </form>
